/*
    Implementation of parsing for expressions.
*/
...
impl Parser<'_> {
    /*
      Expression parsing
    */
    pub(crate) fn parse_py_expr(&mut self) -> ReturnType {
    ...
    */
    pub(crate) fn parse_py_primary_expr(&mut self) -> ReturnType {
    ...
    */
    ...
    pub(crate) fn is_py_expr_first(&self) -> bool {
        matches!(
            self.tok.kind,
            TokenKind::IntLiteral
                | TokenKind::FloatLiteral
